...
| `openwrt/patches/120-ignore-empty-package-version-date.patch` | Ignore empty package version.date files | Select the source directory's timestamp instead of a generated directory with no usable date |
