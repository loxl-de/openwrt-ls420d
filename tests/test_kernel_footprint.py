...
class FootprintTests(unittest.TestCase):
    ...
    def test_retained_candidate_6029330_requires_compression(self):
        # Image size independently measured from the retained uImage.
        kernel = elf([(0x8000, 33139840, 33387568)])
        _, _, decompressor_end, _ = MODULE.check(kernel, 9260254)
        self.assertGreater(decompressor_end - MODULE.DECOMPRESSOR_SCRATCH,
                           MODULE.INITRD_LOAD)
